class CareerModel {
  ...
  CareerModel.fromJson(dynamic json) {
    _careers = json['careers'] != null ? Careers.fromJson(json['careers']) : null;
  }
  Careers? _careers;
CareerModel copyWith({  Careers? careers,
}) => CareerModel(  careers: careers ?? _careers,
);
...
class Careers {
  ...
  num? _to;
  num? _total;
Careers copyWith({  num? currentPage,
  List<Data>? data,
  String? firstPageUrl,
  num? from,
  num? lastPage,
  ...
  num? to,
  num? total,
}) => Careers(  currentPage: currentPage ?? _currentPage,
  data: data ?? _data,
