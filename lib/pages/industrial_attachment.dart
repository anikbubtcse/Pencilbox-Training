...
class IndustrialAttachment extends StatefulWidget {
  const IndustrialAttachment({super.key});

  @override
  State<IndustrialAttachment> createState() => _IndustrialAttachmentState();
}

class _IndustrialAttachmentState extends State<IndustrialAttachment> {
